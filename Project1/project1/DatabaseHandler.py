...
class DatabaseHandler:
    ...
    def canUserAddReviewAndRatingForBook(self, bookId, userId):
    ...
    def addBookReviewAndRating(self, rating, review, book_id, user_id):
...
class MockTestDatabaseHandler(TestCase):
    ...
    def test_retrieveBookData_calledWithPartialQuery_matchOneAuthorAndOneTitle(self):
        self.mockFetchResult = Mock()
        self.mockFetchResult.fetchall.return_value = [{"title": "This good book", "author": "Amazing Author",
                                                       "year": "2012", "isbn": "1234567", "id": "9998"},
                                                      {"title": "That amazing story", "author": "Talented Author",
        ...
        self.assertEquals("This good book", firstBook["title"])
        ...
        self.assertEquals("That amazing story", secondBook["title"])
        self.assertEquals("Talented Author", secondBook["author"])
    ...
    def test_canUserAddReviewAndRatingForBook_calledWithExistingRatingAndReview_returnFalse(self):
        ...
        canAddReview = self.databaseHandler.canUserAddReviewAndRatingForBook("9999", "1234")
    ...
    def test_addBookReview_correctSqlIsExecuted(self):
        self.databaseHandler.addBookReviewAndRating(5, "This is a great book.", "9999", "1234")
